...
class Api::V1::TeamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_v1_team" do
    assert_difference('Api::V1::Team.count') do
      post api_v1_teams_url, params: { api_v1_team: { age_group: @api_v1_team.age_group, coach: @api_v1_team.coach, name: @api_v1_team.name } }, as: :json
    end
  ...
  test "should update api_v1_team" do
    patch api_v1_team_url(@api_v1_team), params: { api_v1_team: { age_group: @api_v1_team.age_group, coach: @api_v1_team.coach, name: @api_v1_team.name } }, as: :json
    assert_response 200
  end
