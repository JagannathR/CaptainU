class Api::V1::PlayersController < ApplicationController
  before_action :set_api_v1_player, only: [:show, :update, :destroy]
  ...
  private
    ...
    def api_v1_player_params
      params.require(:api_v1_player).permit(:first_name, :last_name, :height, :weight, :birthday, :graduation_year, :position, :recruit)
    end
end
